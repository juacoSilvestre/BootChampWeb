...
public class MainController {
   ...
   /* @PostMapping("/addUser")
    public User createUser(@RequestBody User user){
        try{
        if(!(getByEmail(user.getEmail()).equals("")));}catch (Exception e){;
            throw new RuntimeException("The email already exist");
        }
        try{
        if(!(getByUserName(user.getUserName()).equals("")));}catch (Exception e){
            throw new RuntimeException("The Username already exist");}
   ...
   /* @PostMapping("/addUser")
    public User createUser(@RequestBody User user){
        try{
            if(!(getByEmail(user.getEmail()).equals("")) && !(getByUserName(user.getUserName()).equals("")));}catch (Exception e){;
